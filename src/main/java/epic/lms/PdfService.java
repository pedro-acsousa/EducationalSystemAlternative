...
public class PdfService {
    ...
    public InputStream createPdf(String module, String student, String assessment) throws Exception {
        ...
        // document details and credentials
        ...
        if("false".equals(String.valueOf(currentAssessment.isSubmitted()))){ // if not submitted
        ...
        } else if("true".equals(String.valueOf(currentAssessment.isSubmitted()))) { // if submitted
            ...
            // grading status of the assignment
